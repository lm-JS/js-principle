### \_\_proto\_\_(原型链)
　　_proto__成员严格的说这个成员不应该叫这个名字，__proto__是Firefox中的称呼，__proto__只有在Firefox浏览器中才能被访问到。
 ...
 ***因为对象都继承于Object方法,所有原型链的顶端就是Object.prototype;***  
 只有对象中有方法或者明确引用了prototype才有prototype对象，即它的对象有\_\_proto\_\_属性；除非它的原型是Object;
